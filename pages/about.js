...
export default function Contact() {
  return (
    <>
      <Head>
        <title>About ~ Ishani Kathuria</title>
      </Head>
            ...
            <Container className={styles.aboutContainer}>
              <Row className={styles.aboutRow}>
                ...
                <Col lg={6} className={styles.description}>
                    ...
                    <h2>Ishani Kathuria</h2>

                    <h3>Web Developer & Artist</h3>

                    <p>
                      Owner of this tiny little part of the internet I call
                      home. I’m a typical introvert who loves programming, art
                      and books. My creative and imaginative side stems from my
                      deep-seated addiction to books, television, and movies.
                      Everything seems possible in those worlds, from entering
                      dreams to green multiverse portal guns. But that doesn’t
                      mean our real world isn’t interesting. We have plenty of
                      things that one might not believe unless they see it with
                      their own two eyes.
                    </p>
                </Col>
              </Row>
                ...
                <Col lg={4} className={styles.skillCol}>
                  ...
                  <h4>
                    <FontAwesomeIcon
                      ...
                      icon={["fab", "html5"]}
                    />
                    <Badge className={styles.btn + " " + styles.html}>
                      html
                    </Badge>
                  </h4>
